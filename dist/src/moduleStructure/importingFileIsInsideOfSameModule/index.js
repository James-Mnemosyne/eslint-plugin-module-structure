...
function importingFileIsInsideOfSameModule(importingPath, importedPath) {
    ...
    if ((0, helpers_1.isRelativePath)(normalizedImportedPath) &&
        (0, relativePathDoesNotPassThroughAdditionalPrivate_1.relativePathDoesNotPassThroughAdditionalPrivate)(normalizedImportingPath, normalizedImportedPath)) {
        return true;
    }
    if ((0, importingFileIsAtModuleRoot_1.importingFileIsAtModuleRoot)(normalizedImportingPath, normalizedImportedPath)) {
        return true;
    }
    if ((0, importingFileIsInsideOfSameModulePrivate_1.importingFileIsInsideOfSameModulePrivate)(normalizedImportingPath, normalizedImportedPath)) {
        return true;
    }
    return false;
}
