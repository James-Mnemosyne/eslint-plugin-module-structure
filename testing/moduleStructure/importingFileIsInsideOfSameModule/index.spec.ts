          ...
          └── module/
              ...
              └── thing2/
                  └── thing3/
                      └── index.ts *
    */
    it('for paired nested file in modules from top level, absolute', () => {
      const importingPath =
        '/Users/jamesstrynkowski/projects/module-structure-testbed/src/module/thing2/thing3/index.ts';
      const importedPath = 'module/private/thing0/thing1';
      const result = importingFileIsInsideOfSameModule(importingPath, importedPath);
      expect(result).toBeTruthy();
    });
          ...
          └── module/
              ...
              └── thing2/
                  └── thing3/
                      └── index.ts *
    */
    it('for nested files in modules from top level, relative', () => {
      const importingPath =
        '/Users/jamesstrynkowski/projects/module-structure-testbed/src/module/thing2/thing3/index.ts';
      const importedPath = '../../private/thing0/thing1';
      const result = importingFileIsInsideOfSameModule(importingPath, importedPath);
      expect(result).toBeTruthy();
    });
  });
